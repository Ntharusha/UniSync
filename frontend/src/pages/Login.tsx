        ...
        <div className="bg-white/80 backdrop-blur-xl py-10 px-4 shadow-2xl sm:rounded-3xl sm:px-10 border border-white/20">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-gray-400 uppercase tracking-widest px-1">Email or Registration Number</label>
          ...
          {/* BUG-002 fixed: credentials removed from UI — see login_credentials.md for dev reference */}
        </div>
      </motion.div>
    </div>
  );
